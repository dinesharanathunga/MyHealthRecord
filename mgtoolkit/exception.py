...
class InvalidTargetZoneException(ApplicationException):
    """ Exception occures due to invalid target zone specified"""

# TODO: move this to the policy API
class PolicyException(ApplicationException):
    """ Exception occurres in policy processing """

class InvalidMUDFileException(ApplicationException):
    """ Exception occurres due to invalid rule actions in a MUD file """
